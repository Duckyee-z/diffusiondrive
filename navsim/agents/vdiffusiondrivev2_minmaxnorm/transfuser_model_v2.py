...
import copy
from navsim.agents.vdiffusiondrivev2_minmaxnorm.transfuser_config import TransfuserConfig
from navsim.agents.vdiffusiondrivev2_minmaxnorm.transfuser_backbone import TransfuserBackbone
from navsim.agents.vdiffusiondrivev2_minmaxnorm.transfuser_features import BoundingBox2DIndex
from navsim.common.enums import StateSE2Index
from diffusers.schedulers import DDIMScheduler
from navsim.agents.vdiffusiondrivev2_minmaxnorm.modules.conditional_unet1d import ConditionalUnet1D,SinusoidalPosEmb
import torch.nn.functional as F
from navsim.agents.vdiffusiondrivev2_minmaxnorm.modules.blocks import linear_relu_ln,bias_init_with_prob, gen_sineembed_for_position, GridSampleCrossBEVAttention
from navsim.agents.vdiffusiondrivev2_minmaxnorm.modules.multimodal_loss import LossComputer
...
class TrajectoryHead(nn.Module):
    ...
    def __init__(self, num_poses: int, d_ffn: int, d_model: int, plan_anchor_path: str,config: TransfuserConfig):
        ...
        print("================= Init vdiffusiondrivev2.1 ====================")
        self.n_trajs = 20
